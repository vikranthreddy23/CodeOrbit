    ...
    <div className="max-w-6xl mx-auto px-6 md:px-10">
      <div className="grid grid-cols-12 gap-6 items-end">
        ...
        <div className="col-span-12 md:col-span-4 md:pb-4">
          <div className="inline-flex items-center gap-3 -mt-16 mb-8 border-2 border-[#c2410c]/50 bg-[#c2410c]/8 px-7 py-4 rounded-full whitespace-nowrap">
        ...
        <div className="col-span-12 md:col-span-5 rounded-xl overflow-hidden" style={{ background: "linear-gradient(135deg, #0f766e 0%, #115e59 100%)" }}>
          <div className="p-7 flex flex-col h-full">
            ...
            <div className="mt-auto pt-4 border-t border-white/20">
              <a
                href="https://forms.gle/HdgTbsFmhRHngNEDA"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full block text-center bg-white text-[#0f766e] text-[12px] font-bold uppercase tracking-wider px-4 py-3.5 rounded-full hover:bg-yellow-300 transition-colors"
                style={{ fontFamily: "'JetBrains Mono', monospace" }}
              >
